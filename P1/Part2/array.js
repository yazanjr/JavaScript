...
*/
let fix1 =  [ 1,7, 9 ,45 ];
let fix2 = ["Str", "alex","moh"];
let lazy = "l";
let fix3 =  ['the','fox', 'over', lazy, 'dog'];
...
console.log(array.shift());
console.log(array.shift());// return delted item value 
console.log(array.push(10));// return new item index
console.log(array.unshift(8));
console.log(array.unshift(6));// return the new size
array.unshift(4);
array.unshift(3);
array.unshift(1);
console.log(array)
...
console.log(array2.pop());// return delted item value 
console.log(array2.shift());// return delted item value 
console.log(array2.push(10));// return new item index
console.log(array2.unshift(8));
console.log(array2.unshift(6));// return the new size
...
console.log(sumArray([5,9,-7,3.5]))
